          ...
          <div className="mx-auto max-w-4xl px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
            <Link href="/dashboard">
              <div className="flex items-center gap-3 cursor-pointer">
                <img src="/proxy-logo.png" alt="Proxy" className="h-14 w-auto" /><span className="text-xl font-bold tracking-tight">Context Ingestion</span>
              </div>
            </Link>
            <Link href="/dashboard">
    ...
    <div className="min-h-screen bg-[#E8E8E3] text-black" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      <nav className="sticky top-0 z-50 border-b-[3px] border-black bg-[#D1D1CC]">
        <div className="mx-auto max-w-4xl px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
          <Link href="/dashboard">
            <div className="flex items-center gap-3 cursor-pointer">
              <img src="/proxy-logo.png" alt="Proxy" className="h-14 w-auto" /><span className="text-xl font-bold tracking-tight" data-testid="text-context-ingestion">Context Ingestion</span>
            </div>
          </Link>
